...
const demoMenuData = {
  business: {
    ...
    logo: "https://res.cloudinary.com/dgkwdiga4/image/upload/v1745333225/profile_photos/sixsetypyd9m1uwpu8je.jpg",
    socialMedia: {
  ...
  categories: [
    {
      ...
      supplementaires: [
        ...
        {
          _id: "67f5e58c187aaa92f43800d4",
          nom: "sucre",
          description: "best product",
          prix: 3,
          image: {
            url: "https://res.cloudinary.com/dgkwdiga4/image/upload/v1744168334/profile_photos/f8llwfuft7ewag5s4kd3.jpg",
            publicId: "profile_photos/f8llwfuft7ewag5s4kd3"
          },
          visible: true,
          categorie: "67f5d91092c172e3486d12c6",
          createdAt: "2025-04-09T03:12:12.390Z",
          updatedAt: "2025-04-09T03:12:12.390Z",
          __v: 0
        }
      ]
    },
 ...
 * or passed as a prop.
 * It uses the TemplateMiddleware to load the appropriate template component.
 */
interface DemoTemplateProps {
  componentName?: string;
}

const DemoTemplate: React.FC<DemoTemplateProps> = ({ componentName: propComponentName }) => {
  const { componentName: paramComponentName } = useParams();
  ...
  return <TemplateMiddleware componentName={componentName} menuData={demoMenuData} />;
};
